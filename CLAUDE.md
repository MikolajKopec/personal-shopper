...
Landing page dla REFL. — platformy coachingowej dla kobiet (ankieta + CRM).
Aplikacja główna (ankieta) znajduje się w osobnym repo `app-refl`.
...
- `app-refl` — ankieta Next.js (główna aplikacja)
- `refl-landing` — ten projekt (landing page)
